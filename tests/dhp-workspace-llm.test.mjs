...
test("DHP Workspace is protected, original, and keeps browser secrets out", async () => {
  const [page, workspace, adminChat, proxy] = await Promise.all([
  ...
  assert.match(workspace, /Bản nháp cục bộ/);
