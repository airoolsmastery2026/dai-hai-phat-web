      ...
      <Container>
        <Card className="mx-auto max-w-4xl border-white/10 bg-white/10 p-8 shadow-[var(--shadow-lg)] backdrop-blur md:p-12" tone="default">
          ...
          <form className="space-y-6">
            ...
            <button type="submit" className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#FF5722] px-4 py-4 font-semibold text-white transition hover:bg-orange-600">
