  ...
  return (
    <div className="grid gap-6 md:grid-cols-2">
      {projects.map((project) => (
        <Link key={project.slug} href={`/services/${project.slug}`} className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
          <Image src={project.image} alt={project.title} width={800} height={320} className="h-48 w-full object-cover" />
          <div className="p-6">
