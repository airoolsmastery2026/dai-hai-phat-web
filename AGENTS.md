...
1. configured `dhp-free` virtual provider when its gateway can prove a zero-cost route
2. currently valid provider trial/free cloud quota already available to the operator
3. currently valid free cloud quota from another approved coding provider
